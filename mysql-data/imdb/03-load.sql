...
SELECT 'name' AS tbl, COUNT(*) AS cnt FROM name;
...
SELECT 'title' AS tbl, COUNT(*) AS cnt FROM title;
...
SELECT 'title_crew' AS tbl, COUNT(*) AS cnt FROM title_crew;
...
SELECT 'title_principals' AS tbl, COUNT(*) AS cnt FROM title_principals;
